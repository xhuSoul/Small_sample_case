...
public class Packe {
	...
	private static String adressip="172.20.10.3";
...
//		Iterator<Entry<String, Integer>> iterator = mapfordosip.entrySet().iterator();
...
//		}
		...
		if (dstIP.contains(adressip)){
			// 获取接收包的数量
			countacceptpack++;
			// System.out.println("获取包的总流量"+countacceptpack);

		} else if (srcIP.contains(adressip)) {
			countsendpack++;
	...
	public static void setAdressip(String adressip) {
		Packe.adressip = adressip;
	}
